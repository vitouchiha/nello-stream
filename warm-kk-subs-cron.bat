...
REM
REM Programma: C:\Users\vitob\Desktop\bot telegram\Streaming Koreano\StreamFusionMail\warm-kk-subs-cron.bat
...
node warm-kk-subs.js --continue >> kk-subs-warm-cron.log 2>&1
